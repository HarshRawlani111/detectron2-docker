...
def run_inference(img_path='inputImage.jpg'):
...
def predictRoute():
    try:
        ...
        decodeImage(image, clApp.filename) #image = str, clApp.filename = jpg image where we write the info of image variable
        result = clApp.objectDetection.inference('inputImage.jpg')
